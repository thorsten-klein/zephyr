	...
	.memConfig = {
            ...
            .lookupTable = {
                ...
                [0] = FC_FLEXSPI_LUT_SEQ(
                    ...
                    FC_RADDR_SDR, FC_FLEXSPI_4PAD, 0x20),
                ...
                [4 * 2 + 0] = FC_FLEXSPI_LUT_SEQ(
                    ...
                    FC_WRITE_SDR, FC_FLEXSPI_1PAD, 0x04),
                ...
                [4 * 5 + 0] = FC_FLEXSPI_LUT_SEQ(
                    FC_CMD_SDR, FC_FLEXSPI_1PAD, 0x21, 
                    FC_RADDR_SDR, FC_FLEXSPI_1PAD, 0x20),

                /* Block erase */
                [4 * 8 + 0] = FC_FLEXSPI_LUT_SEQ(
                    FC_CMD_SDR, FC_FLEXSPI_1PAD, 0x5C, 
                    FC_RADDR_SDR, FC_FLEXSPI_1PAD, 0x20),

                /* Page program */
                [4 * 9 + 0] = FC_FLEXSPI_LUT_SEQ(
                    FC_CMD_SDR, FC_FLEXSPI_1PAD, 0x12, 
                    FC_RADDR_SDR, FC_FLEXSPI_1PAD, 0x20),
